...
values (301, 'applicatrPrv', 'Applic 8R Provisioners', 'Provisioners for Applic 8R', 301, false, true, current_timestamp(), current_timestamp()),
       ...
       (310, 'stripper', 'Removes measurements', 'Strip Mtrix Provisioners', 310, false, true, current_timestamp(), current_timestamp()),
       (311, 'admin', 'Administers Removals of measurements', 'Strip Mtrix Provisioners', 310, false, true, current_timestamp(), current_timestamp());

--Applications
insert into application ( id, name, display_name, description, provisioner_role_key, is_deleted, created, updated )
